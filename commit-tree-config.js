...
export const icons = {
    ...
    viewDiff: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" style="height:16px;width:16px" viewBox="0 0 16 16"><rect width="12" height="12" x="2" y="2" stroke="#333" rx="1.5"/><path stroke="#4ADE80" stroke-linecap="round" stroke-width="1.7" d="M4.5 5.5H8"/><path stroke="#999" stroke-linecap="round" stroke-width="1.7" d="M4.5 8h7"/><path stroke="#F87171" stroke-linecap="round" stroke-width="1.7" d="M4.5 10.5h5"/></svg>`,
